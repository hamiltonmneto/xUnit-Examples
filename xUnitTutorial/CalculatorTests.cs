...
namespace xUnitTutorial
{
    public class CalculatorTests
    {
        ...
        [Theory]
        [ClassData(typeof(DivisionTestDate))]
        public void DivideManuNumbersTheory(decimal expected, params decimal[] valuesToAdd)
        {
            foreach (var value in valuesToAdd)
            {
                _sut.Add(value);
        ...
        public class DivisionTestDate : IEnumerable<object[]>
        {
